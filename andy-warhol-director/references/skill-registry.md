...
| PROD-11 | tom-cruise-stuntman-personality | `/tom-cruise-stuntman-personality` · `tom-cruise-stuntman-personality/SKILL.md` |
...
| **ME-01 Full grand master ensemble** | all six PROD-06–09 + PROD-11 + andy-warhol-director → video-creator P2 + Voxtral + stunt cues |
...
Handoff protocols: `dr-seuss-script-writer/references/warhol-handoff-protocol.md` · `stephen-spielberg-producer/references/triple-handoff-protocol.md` · `le-corbusier-set-designer/references/quadruple-handoff-protocol.md` · `eddie-vedder-musician/references/master-ensemble-handoff-protocol.md` · `tom-cruise-stuntman-personality/references/stunt-coordinator-voice-guide.md`
...
| mav / stuntman / stunt coordinator / practical stunts / one-take | PROD-11 (+ other masters for ME-01) |
| grand master ensemble / master ensemble / all six / full stack | PROD-06–09 + PROD-11 + andy-warhol-director (grand master handoff) |
| all five / no stunts | PROD-06–09 + andy-warhol-director (quintet — omit PROD-11) |
